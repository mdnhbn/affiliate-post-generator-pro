...
export const INITIAL_PRODUCTS: Product[] = [
  {
    id: 'prod-1',
    title: 'Anker Magnetic Power Bank 10,000mAh Portable Charger',
    amazonUrl: 'https://www.amazon.com/dp/B0C9RNDWMB?tag=yourtag-20',
    features: 'Compact 10K mAh capacity, snappy MagSafe alignment for iPhone 15/14/13, 20W USB-C fast charging output, built-in kickstand for hands-free viewing.',
    priceDiscount: '$44.99 — 25% OFF',
    imageUrl: 'https://images.unsplash.com/photo-1609592424089-a50d28d09819?w=600&auto=format&fit=crop&q=80',
  ...
  },
  {
    ...
    amazonUrl: 'https://www.amazon.com/dp/B09XS7JWHH?tag=yourtag-20',
    features: 'Auto NC Optimizer noise canceling, ultra-comfortable lightweight design, 30-hour battery life with quick charge, crystal clear hands-free calling with 4 beamforming mics.',
    priceDiscount: '$348.00 — 13% OFF',
  ...
  {
    id: 'prod-3',
    title: 'Ninja AF101 Air Fryer 4-Quart Capacity Crisps Roast Reheat',
    amazonUrl: 'https://www.amazon.com/dp/B07FDJMC9Q?tag=yourtag-20',
    features: '4-quart ceramic-coated basket, air fry with up to 75% less fat than traditional frying, wide temperature range 105°F to 400°F, dishwasher safe parts.',
    priceDiscount: '$89.99 — 31% OFF',
